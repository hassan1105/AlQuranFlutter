...
class AudioScreen extends StatefulWidget {
  const AudioScreen({Key? key, required this.index, required this.list})
      : super(key: key);
...
class _AudioScreenState extends State<AudioScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Now Playing',
          style: TextStyle(
              color: HexColor("#8c59d0"), fontWeight: FontWeight.w800),
        ),
      ),
      body: SafeArea(
        child: Container(
  ...
  void _initAudioPlayer(
    ...
    try {
      var url =
          "https://download.quranicaudio.com/quran/abdul_basit_murattal/$ind.mp3";
      print('url $url');
      defaultDuration =
